...
public class LeadPage extends HeaderPage {
	...
	{
	     ca.entervalue(tb_lastname, lname, lname+" has been entered into lastname field");
	...
	public void verifyLeadCreation(String lname, String comp)
	{
		...
		ca.GetTextValidate(lbl_Company, comp, "Text "+comp+" validated against label company");
	}
